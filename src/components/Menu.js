...
export default function Menu() {
  ...
  <a href="index3.html" className="brand-link">
    <img src="dist/img/AdminLTELogo.jpg" alt="AdminLTE Logo" className="brand-image img-circle elevation-3" style={{opacity: '.8'}} />
  ...
  <div className="sidebar">
    ...
    <div className="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div className="info">
        <a href="#" className="d-block">Osanda Lelum</a>
      </div>
    </div>
    {/* Sidebar Menu */}
    <nav className="mt-2">
